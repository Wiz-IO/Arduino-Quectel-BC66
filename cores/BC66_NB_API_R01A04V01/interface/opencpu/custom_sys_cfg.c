...
static const ST_DebugPortSet debugPortSet = {
    PORTNAME_UART2,  	// Set the serial debug port (UART2) to GKI trace log .Can choose UART0/UART1/UART2
    PORTNAME_UART2      // Set the serial debug port (UART1) to HSL eng.  log .Can choose UART0/UART1/UART2
};
